...
%% \IfSubStringInString{mail}{\lxmedia}{    % nur bei Mail
  ...
  % Sprachüberprüfung
  \ifthenelse{\equal{\lxcountry}{}}{\CenterWallPaper{1}{\identpath/briefbogen.pdf}}{
  \ifthenelse{\equal{\lxcountry}{Deutschland}}{\CenterWallPaper{1}{\identpath/briefbogen.pdf}}{\CenterWallPaper{1}{\identpath/briefbogen.pdf}}
  }
...
\geometry{
        ...
        top=45mm,     % Abstand Textanfang von oben
        head=5mm,     % Höhe des Kopfes
        headsep=6mm, % Abstand Kopf zu Textanfang
        bottom=35mm,  % Abstand von unten
